...
<a href="?p=tambah_pegawai" class="btn btn-md btn-primary"><span class="glyphicon glyphicon-plus"></span></a>
    <form class="navbar-form navbar-right" role="search" method="get">
        ...
        <input type="text" class="form-control" placeholder="Cari Pegawai" name="cari"> </div>
...
<table class="table table-bordered table-striped">
    ...
    <tbody>
        ...
        $sql = "SELECT * FROM pegawai $q_cari LIMIT $mulai, $pembagian";
        ...
        <tr>
            ...
            <td><?= $data['nip'] ?></td>
            <td><?= $data['alamat'] ?></td> <td>
                <a href="?p=edit_pegawai&id_pegawai=<?= $data['id_pegawai'] ?>"
                class="btn btn-md btn-primary"><span class="glyphicon glyphicon-edit"></span></a>
                <a onclick="return confirm ('Apakah anda yakin untuk menghapusnya?')" 
                href="page/hapus_pegawai.php?id_pegawai=<?= $data['id_pegawai'] ?>" 
                class="btn btn- md btn-danger"><span class="glyphicon glyphicon-trash"></span></a>
            </td>
        </tr>
        ...
        <td>LAB RPL</td>
        <td>19-11-2021</td>
        <td>Barang di dapat dari bantuan provinsi</td> <td>
        ...
        <ul class="pagination">
            <li>
                <a href="?p=pegawai&halaman=<?= $page - 1 ?>" aria-label="Previous"> 
        ...
        ?>
            <li class="<?= ($i == $_GET['halaman'] ? 'active' : '') ?>">
                <a href="?p=pegawai&halaman=<?= $i ?>"><?= $i ?></a>
            </li>
        ...
        <li><a href="#">5</a></li> -->
            <li>
                <a href="?p=pegawai&halaman=<?= $page + 1 ?>" aria-label="Next"> 
